...
- `l2/t_recall_strain.py` — decoy-invariance (300 heavy decoys leave a fixed cue's
  ranking untouched), murk near-duplicate cues abstaining rather than fabricating,
  and index-vs-log divergence caught even when the checksum is recomputed.
